...
@Slf4j
@RestController
@RequestMapping(value = "/loadData_bc")
@RequiredArgsConstructor
public class LoadDataBcController {

  @Autowired private ConfigService configService;

  @Autowired private LoadDataBcService loaddataBcService;
  ...
  public ResponseEntity<?> loadDatabase() {
    ...
    try {
      ...
      BackendResponse<?> response = loaddataBcService.executeLoadDatabase();
