...
@NoArgsConstructor
@AllArgsConstructor
public class AllExternalCodesEcJoinPeliculasOkResponseResponseDto implements Serializable {

  @JsonProperty("peliculas")
  @Singular("peliculas")
  @Lazy
  private List<AllExternalCodesEcJoinPeliculasOutPeliculasDataDto> peliculas;
}
