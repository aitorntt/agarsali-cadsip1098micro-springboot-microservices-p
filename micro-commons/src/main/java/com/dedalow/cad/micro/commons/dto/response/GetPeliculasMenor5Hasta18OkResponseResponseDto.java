...
@NoArgsConstructor
@AllArgsConstructor
public class GetPeliculasMenor5Hasta18OkResponseResponseDto implements Serializable {

  @JsonProperty("outputSQLResult")
  @Singular("outputSQLResult")
  @Lazy
  private List<GetPeliculasMenor5Hasta18OutOutputSQLResultDataDto> outputSQLResult;
}
