...
@NoArgsConstructor
@AllArgsConstructor
public class AllExternalCodesEcValidateTypesBodyRequestDto implements Serializable {
  ...
  @Singular("typeList")
  @Lazy
  private List<AllExternalCodesEcValidateTypesInTypeListDataDto> typeList;
  ...
  private AllExternalCodesEcValidateTypesInTypeObjectDto typeObject;
