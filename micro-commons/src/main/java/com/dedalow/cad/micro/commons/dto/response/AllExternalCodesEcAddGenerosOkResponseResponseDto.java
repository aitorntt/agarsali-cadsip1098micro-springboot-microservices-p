...
@NoArgsConstructor
@AllArgsConstructor
public class AllExternalCodesEcAddGenerosOkResponseResponseDto implements Serializable {

  @JsonProperty("generos")
  @Singular("generos")
  @Lazy
  private List<AllExternalCodesEcAddGenerosOutGenerosDataDto> generos;
}
