...
@NoArgsConstructor
@AllArgsConstructor
public class GetPeliculasMayor18OkResponseResponseDto implements Serializable {

  @JsonProperty("outputSQLResult")
  @Singular("outputSQLResult")
  @Lazy
  private List<GetPeliculasMayor18OutOutputSQLResultDataDto> outputSQLResult;
}
